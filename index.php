...
<body>
  ...
  <div class="form">
            ...
            <form style="text-align:center;" method="post" action="<?php $_SERVER['PHP_SELF'];?>" >
                <p>
             <input type="text" name="username"  placeholder="username of reporter..." autofocus />
                </p>
...
Hood Incorporation (325 North St. Paul Street #2020 Dallas, TX 75201, USA) Copyright © 2022 Hood - All rights reserved 
      		...
      		<?php
                ...
                $sql = "insert into issue (id,username,type,popis)
                            values ('".$id."','".$username."','".$type."','".$description."')";
                $conn->query($sql);
